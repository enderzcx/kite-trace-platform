...
## Mandatory Workflow
**Every code change MUST follow this flow — no exceptions:**
1. Write code
2. Codex review (`/codex:rescue` or Agent codex:codex-rescue)
3. Fix all findings
4. Then commit / push / deploy

Never skip step 2. If you forget, stop and run the review before proceeding.

---

## Replying to GitHub Issues (claude-to-im-skill)
