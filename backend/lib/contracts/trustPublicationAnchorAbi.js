export const trustPublicationAnchorAbi = [
  ...
  'function publishTrustPublication(string publicationType, string sourceId, string agentId, uint256 agentIdNum, string referenceId, string traceId, bytes32 payloadHash, string detailsURI) returns (uint256)',
